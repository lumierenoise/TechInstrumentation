          ...
          <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  ...
                  <p class="card-category">Perfil completo</p>
                </div>
                <div class="card-body">
                  <form action="" method="post" name="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Número do celular</label>
                    ...
                    <button type="submit" name="btn_save" id="btn_save" class="btn btn-info pull-right">Atualizar Usuário</button>
