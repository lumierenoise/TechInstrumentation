          ...
          <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-info">
                <h4 class="card-title">Orders  / Pedidos <?php echo $page;?> </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-info">
                      <tr><th>Nome do Cliente</th><th>Produto</th><th>Contato | Email</th><th>Endereço</th><th>Detalhes</th><th>Envio</th><th>Tempo</th>
                    </tr></thead>
                    <tbody>
                      <?php 
