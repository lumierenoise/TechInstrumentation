      ...
      <div class="content">
		...
		<a>
                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-info">
                        <tr><th>ID</th><th>Primeiro Nome</th><th>Sobrenome</th><th>Email</th><th>Senha</th><th>Contato</th><th>Endereço</th><th>Cidade</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-info">
                        <tr><th>ID</th><th>Categorias</th><th>Unidades</th>
                    </tr></thead>
                    <tbody>
                      <?php 
          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header card-header-info">
                <h4 class="card-title">Lista de Fabricantes</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-info">
                        <tr><th>ID</th><th>Fabricantes</th><th>Unidades</th>
                    </tr></thead>
                    <tbody>
                      <?php 
